...
class EditorUpdateDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.update_msg_lbl = wx.StaticText(
            self,
            wx.ID_ANY,
        ...
        self.m_gauge1 = wx.Gauge(
            self, wx.ID_ANY, 100, wx.DefaultPosition, wx.Size(400, -1), wx.GA_HORIZONTAL
        )
        ...
        self.cancel_button = wx.Button(
            self, wx.ID_ANY, "Cancel", wx.Point(-1, -1), wx.Size(150, 40), 0
        )
        bSizer2.Add(
            self.cancel_button,
            0,
    ...
    def incrementGauge(self):
        ...
        if self.update_finished == 0:
            ...
            wx.CallAfter(
                self.update_msg_lbl.SetLabelText,
                "Update finished! Please restart OpenPLC Editor.",
            )
            ...
            wx.CallAfter(
                self.update_msg_lbl.SetLabelText,
                "Error while trying to download update.\nCheck your internet connection and try again.",
            )
            wx.CallAfter(self.cancel_button.SetLabel, "Ok")
    ...
    def updater(self, return_code):
        ...
        if platform.system() == "Darwin":
            ...
            )  # bypass SSL errors on macOS - TODO: fix it later
            cloud_file = urllib.request.urlopen(
                "https://github.com/thiagoralves/OpenPLC_Editor/blob/master/revision?raw=true",
                context=context,
            )
        else:
            cloud_file = urllib.request.urlopen(
        ...
        if cloud_revision > local_revision:
            ...
            r = wx.MessageDialog(
                None,
                "You're running the most recent version of OpenPLC Editor. There are no updates available at this time.",
                "OpenPLC Editor Update",
                wx.OK | wx.OK_DEFAULT,
            )
